    ...
    return (React.createElement(Primitives.Provider, { delayDuration: 100 },
        React.createElement(Primitives.Root, { open: open, defaultOpen: defaultOpen, onOpenChange: onOpenChange, delayDuration: delayDuration },
            ...
            React.createElement(Primitives.Portal, null,
                React.createElement(Primitives.Content, { side: side, sideOffset: sideOffset, align: "center", className: clx("txt-compact-xsmall-plus text-ui-fg-subtle animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 bg-ui-bg-base shadow-elevation-tooltip z-[999] rounded-lg px-3 py-2", className), ...props, style: { ...props.style, maxWidth } }, content)))));
};
export { Tooltip };
