...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (React.createElement(Primitives.Viewport, { ref: ref, className: clx("fixed right-0 top-0 z-[100] w-full p-6 md:max-w-[484px]", className), ...props })));
