...
const Root = React.forwardRef(({ className, ...props }, ref) => (React.createElement("div", { className: "w-full overflow-auto" },
    React.createElement("table", { ref: ref, className: clx("text-ui-fg-subtle txt-compact-small w-full", className), ...props }))));
Root.displayName = "Table";
const Row = React.forwardRef(({ className, ...props }, ref) => (React.createElement("tr", { ref: ref, className: clx("bg-ui-bg-base hover:bg-ui-bg-base-hover border-ui-border-base border-b", "[&_td:last-child]:pr-8 [&_th:last-child]:pr-8", "[&_td:first-child]:pl-8 [&_th:first-child]:pl-8", className), ...props })));
...
const Header = React.forwardRef(({ className, ...props }, ref) => (React.createElement("thead", { ref: ref, className: clx("border-ui-border-base txt-compact-small-plus border-y", className), ...props })));
