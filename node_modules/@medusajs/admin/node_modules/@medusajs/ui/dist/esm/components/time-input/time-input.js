...
const TimeSegment = ({ segment, state }) => {
    ...
    return (React.createElement("div", { ...segmentProps, ref: ref, className: clx("txt-compact-medium w-full rounded-md border px-2 py-[5px] text-left uppercase tabular-nums", inputBaseStyles, "group-aria-[invalid=true]/time-input:!border-ui-border-error group-aria-[invalid=true]/time-input:focus:!shadow-borders-error group-invalid/time-input:!border-ui-border-error group-invalid/time-input:focus:!shadow-borders-error", {
