...
const Dialog = ({ open, title, description, verificationText, cancelText = "Cancel", confirmText = "Confirm", onConfirm, onCancel, }) => {
    ...
    return (React.createElement(Prompt, { open: open },
        React.createElement(Prompt.Content, null,
            ...
            verificationText && (React.createElement("form", { onSubmit: handleFormSubmit },
                React.createElement("fieldset", { className: "border-ui-border-base mt-6 flex flex-col gap-y-4 border-y p-6" },
                    React.createElement(Label, { htmlFor: "verificationText", className: "text-subtle" },
                        "Please type",
                        " ",
            ...
            React.createElement(Prompt.Footer, null,
                ...
                React.createElement(Prompt.Action, { onClick: verificationText ? undefined : onConfirm, disabled: !validInput, type: verificationText ? "submit" : "button" }, confirmText)))));
};
