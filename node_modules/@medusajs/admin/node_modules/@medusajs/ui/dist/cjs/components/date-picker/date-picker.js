...
const Display = React.forwardRef(({ className, children, placeholder, ...props }, ref) => {
    return (React.createElement(Primitives.Trigger, { asChild: true },
        React.createElement("button", { ref: ref, className: (0, clx_1.clx)("txt-compact-small grid w-full grid-cols-[20px_1fr] items-center gap-x-2 rounded-md border px-3 py-[9px]", "border-ui-border-loud-muted bg-ui-bg-subtle shadow-buttons-secondary outline-none transition-all", "disabled:bg-ui-bg-disabled disabled:text-ui-fg-disabled disabled:border-ui-border-base disabled:shadow-none", "focus:border-ui-border-interactive focus:shadow-borders-active", "hover:bg-ui-bg-subtle-hover", "active:bg-ui-bg-subtle-pressed", className), ...props },
...
const Flyout = React.forwardRef(({ className, children, ...props }, ref) => {
    return (React.createElement(Primitives.Content, { ref: ref, sideOffset: 4, align: "start", className: (0, clx_1.clx)("txt-compact-small shadow-elevation-flyout bg-ui-bg-base z-[100] rounded-lg", "animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95", "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2", className), ...props }, children));
});
...
const PresetContainer = ({ presets, onSelect, currentValue, }) => {
    ...
    return (React.createElement("ul", { className: "flex flex-col items-start" }, presets.map((preset, index) => {
        return (React.createElement("li", { key: index, className: "w-full" },
            React.createElement("button", { className: (0, clx_1.clx)("txt-compact-small-plus w-full overflow-hidden text-ellipsis whitespace-nowrap rounded-md p-2 text-left", "text-ui-fg-subtle hover:bg-ui-bg-base-hover outline-none transition-all", {
...
const SingleDatePicker = ({ defaultValue, value, onChange, presets, showTimePicker, disabled, className, ...props }) => {
    var _a;
    ...
    return (React.createElement(Primitives.Root, { open: open, onOpenChange: setOpen },
        React.createElement(Display, { placeholder: "Pick a date", disabled: disabled, className: className }, formattedDate),
                ...
                React.createElement("div", { className: "flex items-start" },
                    ...
                    React.createElement("div", null,
                        ...
                        showTimePicker && (React.createElement("div", { className: "border-ui-border-base border-t p-3" },
                            React.createElement(time_input_1.TimeInput, { "aria-label": "Time", onChange: handleTimeChange, isDisabled: !date, value: time }))),
...
const RangeDatePicker = ({ defaultValue, value, onChange, showTimePicker, presets, disabled, className, ...props }) => {
    var _a;
    const [open, setOpen] = React.useState(false);
    ...
    return (React.createElement(Primitives.Root, { open: open, onOpenChange: setOpen },
        React.createElement(Display, { placeholder: "Pick a date", disabled: disabled, className: className }, displayRange),
        React.createElement(Flyout, null,
            React.createElement("div", { className: "flex" },
                React.createElement("div", { className: "flex items-start" },
                    presets && presets.length > 0 && (React.createElement("div", { className: "relative h-full w-[160px] border-r" },
                    ...
                    React.createElement("div", null,
                        ...
                        showTimePicker && (React.createElement("div", { className: "border-ui-border-base flex items-center justify-evenly gap-x-3 border-t p-3" },
                            React.createElement("div", { className: "flex flex-1 items-center gap-x-2" },
                                ...
                                React.createElement(time_input_1.TimeInput, { value: time.start, onChange: (v) => handleTimeChange(v, "start"), "aria-label": "Start date time", isDisabled: !(range === null || range === void 0 ? void 0 : range.from) })),
                            React.createElement(icons_1.Minus, { className: "text-ui-fg-muted" }),
                            React.createElement("div", { className: "flex flex-1 items-center gap-x-2" },
                                React.createElement("span", { className: "text-ui-fg-subtle" }, "End:"),
                                React.createElement(time_input_1.TimeInput, { value: time.end, onChange: (v) => handleTimeChange(v, "end"), "aria-label": "End date time", isDisabled: !(range === null || range === void 0 ? void 0 : range.to) })))),
