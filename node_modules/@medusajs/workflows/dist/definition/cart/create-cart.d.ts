...
export declare const createCart: <TDataOverride = undefined, TResultOverride = undefined>(container?: import("@medusajs/types").MedusaContainer | {
    ...
    run: (args?: import("../../helper").FlowRunOptions<TDataOverride extends undefined ? CartWorkflow.CreateCartWorkflowInputDTO : TDataOverride> | undefined) => Promise<import("../../helper").WorkflowResult<TResultOverride extends undefined ? CreateCartWorkflowOutput : TResultOverride>>;
};
export {};
