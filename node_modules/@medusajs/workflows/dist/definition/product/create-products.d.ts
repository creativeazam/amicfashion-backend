...
export declare const createProducts: <TDataOverride = undefined, TResultOverride = undefined>(container?: import("@medusajs/types").MedusaContainer | {
    __joinerConfig: import("@medusajs/types").JoinerServiceConfig;
    __definition: import("@medusajs/types").ModuleDefinition;
}[] | undefined) => Omit<import("@medusajs/orchestration").LocalWorkflow, "run"> & {
    run: (args?: import("../../helper").FlowRunOptions<TDataOverride extends undefined ? WorkflowTypes.ProductWorkflow.CreateProductsWorkflowInputDTO : TDataOverride> | undefined) => Promise<import("../../helper").WorkflowResult<TResultOverride extends undefined ? ProductTypes.ProductDTO[] : TResultOverride>>;
};
