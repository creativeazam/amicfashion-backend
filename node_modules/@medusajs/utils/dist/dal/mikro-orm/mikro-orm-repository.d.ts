...
declare class MikroOrmBase<T = any> {
...
export declare abstract class MikroOrmAbstractBaseRepository<T = any> extends MikroOrmBase implements DAL.RepositoryService<T> {
    ...
    softDelete(ids: string[], { transactionManager: manager }?: Context): Promise<[T[], Record<string, unknown[]>]>;
    restore(ids: string[], { transactionManager: manager }?: Context): Promise<T[]>;
}
