...
function mikroOrmConnectionLoader(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var manager, dbConfig, shouldSwallowError, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    shouldSwallowError = !!(options === null || options === void 0 ? void 0 : options.database.connection);
                    dbConfig = __assign(__assign({}, (0, load_module_database_config_1.loadDatabaseConfig)("product", (options !== null && options !== void 0 ? options : {}), shouldSwallowError)), { connection: options === null || options === void 0 ? void 0 : options.database.connection });
